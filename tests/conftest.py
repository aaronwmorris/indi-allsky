...
if 'PyIndi' not in sys.modules:
    try:
        ...
        class MockBaseDevice:
            ...
            SENSOR_INTERFACE = 26624
            AUX_INTERFACE = 32768
            OUTPUT_INTERFACE = 65536
            INPUT_INTERFACE = 131072
            POWER_INTERFACE = 262144

        mock_pyindi.BaseDevice = MockBaseDevice
        ...
        mock_pyindi.INDI_UNKNOWN = 5
        mock_pyindi.B_NEVER = 0
        mock_pyindi.B_ALSO = 1
        mock_pyindi.B_ONLY = 2
