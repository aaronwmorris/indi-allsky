...
class VideoWorker(Process):
    ...
    def generateVideo(self, task, timespec, img_folder, night, camera):
        ...
        self._miscUpload.upload_video(video_entry, video_file, camera)
    ...
    def generateKeogramStarTrails(self, task, timespec, img_folder, night, camera):
        ...
        if keogram_entry:
            if keogram_file.exists():
                ...
                self._miscUpload.upload_keogram(keogram_entry, keogram_file, camera)
            else:
        ...
        if startrail_entry and night:
            if startrail_file.exists():
                ...
                self._miscUpload.upload_startrail(startrail_entry, startrail_file, camera)
            else:
        ...
        if startrail_video_entry and night:
            if startrail_video_file.exists():
                ...
                self._miscUpload.upload_startrailvideo(startrail_video_entry, startrail_video_file, camera)
            else:
