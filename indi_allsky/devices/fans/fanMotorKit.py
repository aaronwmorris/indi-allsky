...
class FanMotorKitPwm(FanBase):

    def __init__(self, *args, **kwargs):
        super(FanMotorKitPwm, self).__init__(*args, **kwargs)
        ...
        # pin 1 should be the name for the motor
        motor_name = str(pin_1_name)
    ...
    def deinit(self):
        super(FanMotorKitPwm, self).deinit()
