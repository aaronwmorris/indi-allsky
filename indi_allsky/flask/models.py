...
class IndiAllSkyDbCameraTable(db.Model):
    ...
    minBinning = db.Column(db.Integer, server_default='1', nullable=True)
    maxBinning = db.Column(db.Integer, server_default='1', nullable=True)
...
class IndiAllSkyDbDarkFrameTable(IndiAllSkyDbFileBase):
    ...
    gain = db.Column(db.Float, nullable=False, index=True)
