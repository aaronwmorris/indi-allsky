...
class IndiAllSkyDbCameraTable(db.Model):
    ...
    createDate = db.Column(db.DateTime(timezone=False), nullable=False, server_default=db.func.now())
...
class IndiAllSkyDbImageTable(IndiAllSkyDbFileBase):
    ...
    createDate = db.Column(db.DateTime(timezone=False), nullable=False, index=True, server_default=db.func.now())
...
class IndiAllSkyDbNotificationTable(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    createDate = db.Column(db.DateTime(timezone=False), nullable=False, index=True, server_default=db.func.now())
    expireDate = db.Column(db.DateTime(timezone=False), nullable=False, index=True)
...
class IndiAllSkyDbUserTable(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    createDate = db.Column(db.DateTime(timezone=False), nullable=False, server_default=db.func.now())
    passwordDate = db.Column(db.DateTime(timezone=False), nullable=False, server_default=db.func.now())
