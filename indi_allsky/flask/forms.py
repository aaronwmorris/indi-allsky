...
class IndiAllskyConfigForm(FlaskForm):
    ...
    TEMP_SENSOR__SI1145_GAIN_NIGHT   = SelectField('SI1145 Gain (Night)', choices=TEMP_SENSOR__SI1145_GAIN_choices, validators=[TEMP_SENSOR__SI1145_GAIN_validator])
    TEMP_SENSOR__SI1145_GAIN_DAY     = SelectField('SI1145 Gain (Day)', choices=TEMP_SENSOR__SI1145_GAIN_choices, validators=[TEMP_SENSOR__SI1145_GAIN_validator])
