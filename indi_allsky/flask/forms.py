...
class IndiAllskyConfigForm(FlaskForm):
    ...
    TEMP_SENSOR__CLASSNAME_choices = (
        ...
        ('blinka_temp_sensor_bmp180_i2c', 'BMP180 i2c - 2 Slots'),
    ...
    TEMP_SENSOR__A_VAR_SLOT          = SelectField('Sensor Slot', choices=SENSOR_USER_VAR_SLOT_choices, validators=[SENSOR_USER_VAR_SLOT_validator])
    ...
    TEMP_SENSOR__B_VAR_SLOT          = SelectField('Sensor Slot', choices=SENSOR_USER_VAR_SLOT_choices, validators=[SENSOR_USER_VAR_SLOT_validator])
