...
class IndiAllskyConfigForm(FlaskForm):
    ...
    TEMP_SENSOR__CLASSNAME_choices = {
        ...
        'Temperature Sensors' : (
            ...
            ('blinka_temp_sensor_bme280_i2c', 'BMP/BME280 i2c - Temp/RH/Pres/DP (4 slots)'),
            ('blinka_temp_sensor_bme280_spi', 'BMP/BME280 SPI - Temp/RH/Pres/DP (4 slots)'),
        ...
        'Lightning Sensors' : (
            ('blinka_sparkfun_lightning_sensor_as3935_spi', 'AS3935 SPI - (6 slots)'),
            ('blinka_sparkfun_lightning_sensor_as3935_i2c', 'AS3935 i2c - (6 slots)'),
        ),
        'Remote' : (
