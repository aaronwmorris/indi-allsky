...
class IndiAllskyConfigForm(FlaskForm):
    ...
    TEMP_SENSOR__CLASSNAME_choices = {
        ...
        'Temperature Sensors' : (
            ...
            ('blinka_temp_sensor_htu31d_i2c', 'HTU31D i2c - Temp/RH (3)'),
            ('blinka_temp_sensor_ahtx0_i2c', 'AHT10/20 i2c - Temp/RH (3)'),
            ('blinka_temp_sensor_scd30_i2c', 'SCD-30 i2c - Temp/RH/CO2 (4)'),
            ('blinka_temp_sensor_scd4x_i2c', 'SCD-4x i2c - Temp/RH/CO2 (4)'),
