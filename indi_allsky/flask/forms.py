...
class IndiAllskyConfigForm(FlaskForm):
    ...
    CCD_CONFIG__NIGHT__GAIN          = FloatField('Night Gain', validators=[ccd_GAIN_validator], render_kw={'type' : 'number', 'step' : 1.0})
    CCD_CONFIG__NIGHT__BINNING       = IntegerField('Night Bin Mode', validators=[DataRequired(), ccd_BINNING_validator])
    CCD_CONFIG__MOONMODE__GAIN       = FloatField('Moon Mode Gain', validators=[ccd_GAIN_validator], render_kw={'type' : 'number', 'step' : 1.0})
    CCD_CONFIG__MOONMODE__BINNING    = IntegerField('Moon Mode Bin Mode', validators=[DataRequired(), ccd_BINNING_validator])
    CCD_CONFIG__DAY__GAIN            = FloatField('Daytime Gain', validators=[ccd_GAIN_validator], render_kw={'type' : 'number', 'step' : 1.0})
    ...
    WBR_FACTOR                       = FloatField('Red Balance Factor (Night)', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBG_FACTOR                       = FloatField('Green Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBB_FACTOR                       = FloatField('Blue Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBR_FACTOR_DAY                   = FloatField('Red Balance Factor (Day)', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBG_FACTOR_DAY                   = FloatField('Green Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBB_FACTOR_DAY                   = FloatField('Blue Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    AUTO_WB                          = BooleanField('Auto White Balance (Night)')
    AUTO_WB_DAY                      = BooleanField('Auto White Balance (Day)')
    SATURATION_FACTOR                = FloatField('Saturation Factor (Night)', validators=[SATURATION_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    SATURATION_FACTOR_DAY            = FloatField('Saturation Factor (Day)', validators=[SATURATION_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    GAMMA_CORRECTION                 = FloatField('Gamma Correction (Night)', validators=[GAMMA_CORRECTION_validator], render_kw={'type' : 'number', 'step' : 0.1})
    GAMMA_CORRECTION_DAY             = FloatField('Gamma Correction (Day)', validators=[GAMMA_CORRECTION_validator], render_kw={'type' : 'number', 'step' : 0.1})
    ...
    KEOGRAM_ANGLE                    = FloatField('Keogram Rotation Angle', validators=[KEOGRAM_ANGLE_validator], render_kw={'type' : 'number', 'step' : 0.5})
...
class IndiAllskyImageProcessingForm(FlaskForm):
    ...
    WBR_FACTOR                       = FloatField('Red Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBG_FACTOR                       = FloatField('Green Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    WBB_FACTOR                       = FloatField('Blue Balance Factor', validators=[WB_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    AUTO_WB                          = BooleanField('Auto White Balance')
    SATURATION_FACTOR                = FloatField('Saturation Factor', validators=[SATURATION_FACTOR_validator], render_kw={'type' : 'number', 'step' : 0.1})
    GAMMA_CORRECTION                 = FloatField('Gamma Correction', validators=[GAMMA_CORRECTION_validator], render_kw={'type' : 'number', 'step' : 0.1})
