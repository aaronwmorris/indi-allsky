...
class IndiAllSkyDarks(object):
    ...
    def _tempaverage(self):
        ...
        next_temp_thold = self.sensors_av.value[0] - self.temp_delta
        ...
        while True:
            ...
            if self.sensors_av.value[0] > next_temp_thold:
                time.sleep(20.0)
                continue
    ...
    def _take_exposures(self, exposure, dark_filename_t, bpm_filename_t, ccd_bits, stacking_class):
        ...
        while i <= self.count:
            ...
            self.getSensorTemperature()
            logger.info('Sensor temperature: %0.2f', self.sensors_av.value[0])
