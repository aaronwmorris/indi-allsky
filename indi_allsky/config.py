...
class IndiAllSkyConfigBase(object):
    ...
    _base_config = OrderedDict({
        ...
        "FILETRANSFER" : {
            ...
            "REMOTE_VIDEO_NAME"          : "allsky-timelapse_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
            "REMOTE_VIDEO_FOLDER"        : "/home/allsky/upload/allsky/videos",
            "REMOTE_MINI_VIDEO_NAME"     : "allsky-minitimelapse_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
            "REMOTE_MINI_VIDEO_FOLDER"   : "/home/allsky/upload/allsky/videos",
            "REMOTE_KEOGRAM_NAME"        : "allsky-keogram_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
            "REMOTE_KEOGRAM_FOLDER"      : "/home/allsky/upload/allsky/keograms",
            "REMOTE_STARTRAIL_NAME"      : "allsky-startrail_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
            "REMOTE_STARTRAIL_FOLDER"    : "/home/allsky/upload/allsky/startrails",
            "REMOTE_STARTRAIL_VIDEO_NAME": "allsky-startrail_timelapse_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
            "REMOTE_STARTRAIL_VIDEO_FOLDER" : "/home/allsky/upload/allsky/videos",
            "REMOTE_PANORAMA_VIDEO_NAME" : "allsky-panorama_timelapse_ccd{camera_id:d}_{ts:%Y%m%d_%H%M%S}_{tod:s}.{ext}",
