...
while [ -z "${CAMERA_INTERFACE:-}" ]; do
    ...
    if [ "$CAMERA_INTERFACE" == "libcamera" ]; then
        ...
        select libcamera_interface in libcamera_imx477 libcamera_imx378 libcamera_imx219 libcamera_imx519 libcamera_imx708 libcamera_imx290 libcamera_imx462 libcamera_64mp_hawkeye; do
...
if [[ "$CAMERA_INTERFACE" == "libcamera_imx477" || "$CAMERA_INTERFACE" == "libcamera_imx378" || "$CAMERA_INTERFACE" == "libcamera_imx219" || "$CAMERA_INTERFACE" == "libcamera_imx519" || "$CAMERA_INTERFACE" == "libcamera_imx708" || "$CAMERA_INTERFACE" == "libcamera_64mp_hawkeye" ]]; then
